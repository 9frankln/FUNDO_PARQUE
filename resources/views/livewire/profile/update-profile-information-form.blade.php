...
<section>
    <header>
        ...
        <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
            {{ __('Actualice la información de su cuenta, su nombre de usuario y su dirección de correo electrónico.') }}
        </p>
    </header>
            ...
            @if (auth()->user() instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! auth()->user()->hasVerifiedEmail())
                <div>
                    <p class="text-sm mt-2 text-zinc-800 dark:text-zinc-200">
                        ...
                        <button wire:click.prevent="sendVerification" class="underline text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 dark:focus:ring-offset-zinc-900">
