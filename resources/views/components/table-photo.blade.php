...
@else
    <span title="Sin foto" class="{{ $boxClass }} inline-flex items-center justify-center border border-dashed border-slate-300 bg-slate-50 text-slate-400 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-600">
