...
<div x-data="engordeDashboard(@js($data))" class="space-y-6">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <article class="group relative overflow-hidden rounded-[1.5rem] border border-zinc-200/60 bg-gradient-to-b from-white/80 to-white/40 p-5 shadow-sm backdrop-blur-md transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-zinc-200/40 dark:border-zinc-700/50 dark:from-zinc-800/80 dark:to-zinc-800/40 dark:hover:shadow-black/40">
            ...
            <div class="relative flex h-full flex-col justify-between">
                ...
                <div class="mt-4">
                    <p class="text-4xl font-black tracking-tight text-zinc-900 dark:text-white">{{ number_format($data['totalLotes']) }}</p>
                    <p class="mt-1 flex items-center gap-1.5 text-xs font-semibold text-zinc-500 dark:text-zinc-400">
                        <span class="inline-block h-1.5 w-1.5 rounded-full bg-emerald-500"></span> {{ $data['lotesActivos'] }} Activos
                    </p>
                </div>
            </div>
        </article>
        ...
        <article class="group relative overflow-hidden rounded-[1.5rem] border border-zinc-200/60 bg-gradient-to-b from-white/80 to-white/40 p-5 shadow-sm backdrop-blur-md transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-zinc-200/40 dark:border-zinc-700/50 dark:from-zinc-800/80 dark:to-zinc-800/40 dark:hover:shadow-black/40">
            ...
            <div class="relative flex h-full flex-col justify-between">
                ...
                <div class="mt-4">
                    <p class="text-4xl font-black tracking-tight text-zinc-900 dark:text-white">{{ number_format($data['animalesActivos']) }}</p>
                    <p class="mt-1 flex items-center gap-1.5 text-xs font-semibold text-zinc-500 dark:text-zinc-400">
        ...
        <article class="group relative overflow-hidden rounded-[1.5rem] border border-zinc-200/60 bg-gradient-to-b from-white/80 to-white/40 p-5 shadow-sm backdrop-blur-md transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-zinc-200/40 dark:border-zinc-700/50 dark:from-zinc-800/80 dark:to-zinc-800/40 dark:hover:shadow-black/40">
            ...
            <div class="relative flex h-full flex-col justify-between">
                ...
                <div class="mt-4">
                    <p class="text-4xl font-black tracking-tight text-zinc-900 dark:text-white">{{ number_format($data['animalesCerrados']) }}</p>
                    <p class="mt-1 flex items-center gap-1.5 text-xs font-semibold text-zinc-500 dark:text-zinc-400">
            ...
            <div class="relative flex h-full flex-col justify-between">
                ...
                <div class="mt-4">
                    <p class="text-4xl font-black tracking-tight text-zinc-900 dark:text-white">
                        {{ ($data['animalesCerrados'] + $data['animalesActivos']) > 0 ? round(($data['animalesCerrados'] / ($data['animalesCerrados'] + $data['animalesActivos'])) * 100, 1) : 0 }}%
                    </p>
                    <p class="mt-1 flex items-center gap-1.5 text-xs font-semibold text-zinc-500 dark:text-zinc-400">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 mt-6">
        ...
        <div class="rounded-[1.5rem] border border-zinc-200/60 bg-white/60 p-6 shadow-sm backdrop-blur-md dark:border-zinc-700/50 dark:bg-zinc-800/50">
            ...
            <div class="space-y-4">
                @forelse($data['estadosAnimales'] as $index => $item)
                    @php
                        $colorClasses = [
                            0 => 'bg-emerald-500',
                            1 => 'bg-indigo-500',
        ...
        <div class="rounded-[1.5rem] border border-zinc-200/60 bg-white/60 p-6 shadow-sm backdrop-blur-md dark:border-zinc-700/50 dark:bg-zinc-800/50">
            ...
            <div class="space-y-4">
                @forelse($data['sexoAnimales'] as $item)
                    @php
                    ...
                    <div>
                        ...
                        <div class="mt-2 h-2 w-full overflow-hidden rounded-full bg-zinc-100 dark:bg-zinc-700/50">
                            <div class="h-full rounded-full {{ $colorClass }} transition-all duration-1000" style="width: {{ $item['percentage'] }}%"></div>
                        </div>
                    </div>
                @empty
                    <p class="text-sm text-zinc-500 dark:text-zinc-400 font-medium">No hay datos suficientes.</p>
