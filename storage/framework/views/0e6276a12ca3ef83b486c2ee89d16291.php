<style>
    :root {
<?php $__currentLoopData = $branding->paletteRgb(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shade => $rgb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        --brand-<?php echo e($shade); ?>: <?php echo e($rgb); ?>;
...
<?php /**PATH G:\PROYECTOS\FUNDO_PARQUE v04\resources\views/components/brand-theme.blade.php ENDPATH**/ ?>