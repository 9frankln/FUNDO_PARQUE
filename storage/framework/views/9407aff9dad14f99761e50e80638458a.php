        ...
        <div>
            ...
            <div class="relative">
                ...
                <input wire:model="form.email" id="modal-email" type="text" required autocomplete="username"
                       class="w-full rounded-2xl border <?php $__errorArgs = ['form.email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500/80 bg-red-500/5 focus:border-red-500 focus:ring-red-500/20 <?php else: ?> border-emerald-900/10 bg-emerald-50/70 focus:border-emerald-500 focus:ring-emerald-500/10 dark:border-emerald-200/10 dark:bg-emerald-950/50 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> py-3.5 pl-12 pr-4 text-sm text-emerald-950 outline-none transition placeholder:text-emerald-700/60 dark:placeholder:text-emerald-300/70 focus:ring-4 dark:text-emerald-50"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sessionLimitReached): ?>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input wire:model="form.password" id="modal-password" :type="showPassword ? 'text' : 'password'" required autocomplete="current-password"
                       class="w-full rounded-2xl border <?php $__errorArgs = ['form.password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500/80 bg-red-500/5 focus:border-red-500 focus:ring-red-500/20 <?php else: ?> border-emerald-900/10 bg-emerald-50/70 focus:border-emerald-500 focus:ring-emerald-500/10 dark:border-emerald-200/10 dark:bg-emerald-950/50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> py-3.5 pl-12 pr-11 text-sm text-emerald-950 outline-none transition placeholder:text-emerald-700/60 dark:placeholder:text-emerald-300/70 focus:ring-4 dark:text-emerald-50"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <button type="submit" wire:loading.attr="disabled" wire:target="login"
            ...
            <span>Entrar a <?php echo e($branding->name()); ?></span>
...
</div><?php /**PATH G:\PROYECTOS\FUNDO_PARQUE v04\resources\views\livewire/welcome/login-modal.blade.php ENDPATH**/ ?>