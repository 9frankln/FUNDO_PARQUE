...
<div
    x-data="imageFrameEditor({
        initiallyOpen: <?php echo \Illuminate\Support\Js::from($isInitiallyOpen)->toHtml() ?>,
        focusX: $wire.entangle(<?php echo \Illuminate\Support\Js::from($xModel)->toHtml() ?>),
        focusY: $wire.entangle(<?php echo \Illuminate\Support\Js::from($yModel)->toHtml() ?>),
        zoom: $wire.entangle(<?php echo \Illuminate\Support\Js::from($zoomModel)->toHtml() ?>),
        saveAction: <?php echo \Illuminate\Support\Js::from($saveAction)->toHtml() ?>,
        closeAction: <?php echo \Illuminate\Support\Js::from($closeAction)->toHtml() ?>,
    })"
    <?php echo e($attributes->class(['image-frame-editor'])); ?>

>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (! ($isInitiallyOpen)): ?>
        <button
            x-ref="trigger"
            type="button"
            x-on:click.stop.prevent="open($event)"
            x-bind:aria-expanded="visible"
            aria-controls="<?php echo e($dialogId); ?>"
            ...
            >
                <header class="image-frame-editor__header">
                    <div class="image-frame-editor__heading">
                        ...
                        <h2 id="<?php echo e($titleId); ?>" class="image-frame-editor__title"><?php echo e($title); ?></h2>
                        <p id="<?php echo e($descriptionId); ?>" class="image-frame-editor__description"><?php echo e($description); ?></p>
                    </div>
                ...
                <div class="image-frame-editor__body">
                    <div class="image-frame-editor__workspace">
                        ...
                        <aside class="image-frame-editor__inspector" aria-label="Controles de encuadre">
                            ...
                            <div class="image-frame-editor__slot"><?php echo e($slot); ?></div>
                        </aside>
                    </div>
                </div>
                ...
                <footer class="image-frame-editor__footer">
                    ...
                    <button
                        ...
                        <?php if($saveAction): ?>
                            ...
                            wire:target="<?php echo e($saveAction); ?>"
                        <?php endif; ?>
                        class="agro-button"
                    ><?php echo e($applyLabel); ?></button>
                </footer>
            </section>
        </div>
    </template>
</div>
<?php /**PATH G:\PROYECTOS\FUNDO_PARQUE v04\resources\views/components/image-frame-editor.blade.php ENDPATH**/ ?>