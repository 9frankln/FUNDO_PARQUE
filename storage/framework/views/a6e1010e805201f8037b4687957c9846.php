<div class="mx-auto max-w-5xl space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex items-center gap-4">
            <a href="<?php echo e(route('finanzas.index', ['tab' => 'movimientos'])); ?>"
            ...
            <div>
                ...
                <h1 class="mt-1 text-3xl font-extrabold tracking-tight text-zinc-100"><?php echo e($movimiento->categoria?->nombre ?? 'Sin categoría'); ?></h1>
                <p class="mt-1 text-sm text-zinc-500">Referencia MOV-<?php echo e(str_pad((string) $movimiento->id, 6, '0', STR_PAD_LEFT)); ?> · <?php echo e($movimiento->fecha->format('d/m/Y')); ?></p>
            </div>
        </div>
        ...
        <div class="flex flex-wrap gap-2">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->tienePermiso('finanzas', 'actualizar')): ?>
                <a href="<?php echo e(route('finanzas.movimiento.edit', $movimiento->id)); ?>"
        ...
        <section class="overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-900">
            <div class="aspect-[4/3] bg-zinc-950">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($movimiento->comprobante_ruta && $movimiento->comprobanteEsImagen()): ?>
                    ...
                    ?>
                    <a href="<?php echo e($receiptUrl); ?>" target="_blank" rel="noopener" title="Abrir comprobante completo">
                        <img src="<?php echo e($receiptUrl); ?>" alt="Comprobante del movimiento" class="h-full w-full object-cover" decoding="async" style="object-position: <?php echo e($receiptDetailFrame['x']); ?>% <?php echo e($receiptDetailFrame['y']); ?>%; transform: scale(<?php echo e($receiptDetailFrame['zoom']); ?>); transform-origin: <?php echo e($receiptDetailFrame['x']); ?>% <?php echo e($receiptDetailFrame['y']); ?>%;">
                    </a>
                <?php elseif($movimiento->comprobante_ruta): ?>
                    <div class="flex h-full flex-col items-center justify-center gap-4 text-zinc-500">
                        ...
                        <a href="<?php echo e(route('movimiento.comprobante', $movimiento)); ?>" target="_blank" rel="noopener" class="rounded-xl border border-rose-500/25 bg-rose-500/10 px-4 py-2 text-sm font-bold text-rose-300">Abrir comprobante PDF</a>
                    </div>
                <?php else: ?>
            ...
            <div class="border-t border-zinc-800 p-5">
                ...
                <p class="mt-1 text-3xl font-extrabold <?php echo e($movimiento->tipo === 'ingreso' ? 'text-emerald-300' : 'text-rose-300'); ?>">
        ...
        <section class="rounded-3xl border border-zinc-800 bg-zinc-900 p-6 sm:p-8">
            ...
            <dl class="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div class="rounded-2xl border border-zinc-800 bg-zinc-950/60 p-4">
                    ...
                    <dd class="mt-1.5 font-semibold <?php echo e($movimiento->tipo === 'ingreso' ? 'text-emerald-300' : 'text-rose-300'); ?>"><?php echo e(ucfirst($movimiento->tipo)); ?></dd>
                </div>
                <div class="rounded-2xl border border-zinc-800 bg-zinc-950/60 p-4">
                    <dt class="text-[10px] font-bold uppercase tracking-wider text-zinc-500">Categoría</dt>
                    <dd class="mt-1.5 font-semibold text-zinc-100"><?php echo e($movimiento->categoria?->nombre ?? 'Sin categoría'); ?></dd>
                </div>
                <div class="rounded-2xl border border-zinc-800 bg-zinc-950/60 p-4">
                    <dt class="text-[10px] font-bold uppercase tracking-wider text-zinc-500">Fecha</dt>
                    <dd class="mt-1.5 font-semibold text-zinc-100"><?php echo e($movimiento->fecha->format('d/m/Y')); ?></dd>
                </div>
                <div class="rounded-2xl border border-zinc-800 bg-zinc-950/60 p-4">
                    <dt class="text-[10px] font-bold uppercase tracking-wider text-zinc-500">Moneda</dt>
                    <dd class="mt-1.5 font-semibold text-zinc-100"><?php echo e($movimiento->moneda); ?></dd>
                </div>
            </dl>
            ...
            <div class="mt-5 rounded-2xl border border-zinc-800 bg-zinc-950/60 p-4">
                ...
                <p class="mt-2 whitespace-pre-line text-sm leading-6 text-zinc-300"><?php echo e($movimiento->descripcion ?: 'Sin descripción adicional.'); ?></p>
            </div>
        </section>
    </div>

</div>
<?php /**PATH G:\PROYECTOS\FUNDO_PARQUE v04\resources\views/livewire/finanzas/movimiento-show.blade.php ENDPATH**/ ?>