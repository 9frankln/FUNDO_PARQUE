...
<section wire:ignore x-data="animalDashboard(<?php echo \Illuminate\Support\Js::from($data)->toHtml() ?>)" x-cloak
            ...
            <div class="max-w-2xl">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <span class="flex items-center gap-1.5 text-xs font-semibold text-zinc-500 dark:text-zinc-400">
                        ...
                        Actualizado <?php echo e($data['generatedAt']); ?>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <article class="group relative overflow-hidden rounded-[1.5rem] border border-zinc-200/60 bg-gradient-to-b from-white/80 to-white/40 p-5 shadow-sm backdrop-blur-md transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-zinc-200/40 dark:border-zinc-700/50 dark:from-zinc-800/80 dark:to-zinc-800/40 dark:hover:shadow-black/40">
                ...
                <div class="relative flex flex-col h-full justify-between">
                    ...
                    <div class="mt-4">
                        <p class="text-4xl font-black tracking-tight text-zinc-900 dark:text-white"><?php echo e(number_format($data['total'])); ?></p>
                ...
                <div class="relative flex flex-col h-full justify-between">
                    ...
                    <div class="mt-4">
                        <div class="flex items-baseline gap-2">
                            <p class="text-4xl font-black tracking-tight text-zinc-900 dark:text-white"><?php echo e(number_format($data['hembras'])); ?></p>
                            <span class="text-sm font-bold text-pink-600 dark:text-pink-400"><?php echo e($data['total'] > 0 ? round(($data['hembras'] / $data['total']) * 100, 1) : 0); ?>%</span>
                        </div>
                        <p class="mt-1 text-xs font-semibold text-zinc-500 dark:text-zinc-400">
            ...
            <article class="group relative overflow-hidden rounded-[1.5rem] border border-zinc-200/60 bg-gradient-to-b from-white/80 to-white/40 p-5 shadow-sm backdrop-blur-md transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-zinc-200/40 dark:border-zinc-700/50 dark:from-zinc-800/80 dark:to-zinc-800/40 dark:hover:shadow-black/40">
                ...
                <div class="relative flex flex-col h-full justify-between">
                    ...
                    <div class="mt-4">
                        <div class="flex items-baseline gap-2">
                            <p class="text-4xl font-black tracking-tight text-zinc-900 dark:text-white"><?php echo e(number_format($data['machos'])); ?></p>
                            <span class="text-sm font-bold text-blue-600 dark:text-blue-400"><?php echo e($data['total'] > 0 ? round(($data['machos'] / $data['total']) * 100, 1) : 0); ?>%</span>
                        </div>
                        <p class="mt-1 text-xs font-semibold text-zinc-500 dark:text-zinc-400">
            ...
            <article class="group relative overflow-hidden rounded-[1.5rem] border border-zinc-200/60 bg-gradient-to-b from-white/80 to-white/40 p-5 shadow-sm backdrop-blur-md transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-zinc-200/40 dark:border-zinc-700/50 dark:from-zinc-800/80 dark:to-zinc-800/40 dark:hover:shadow-black/40">
                ...
                <div class="relative flex flex-col h-full justify-between">
                    ...
                    <div class="mt-4">
                        <div class="flex items-baseline gap-2">
                            <p class="text-4xl font-black tracking-tight text-zinc-900 dark:text-white"><?php echo e(number_format($data['aptos'])); ?></p>
                            <span class="text-sm font-bold text-amber-600 dark:text-amber-400"><?php echo e($data['hembras'] > 0 ? round(($data['aptos'] / $data['hembras']) * 100, 1) : 0); ?>% <span class="text-[10px] text-zinc-400">/ hembras</span></span>
                        </div>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="rounded-[1.5rem] border border-zinc-200/60 bg-white/60 p-5 shadow-sm backdrop-blur-md dark:border-zinc-700/50 dark:bg-zinc-800/50">
                <div class="mb-5 flex items-center justify-between">
                    ...
                    <span class="flex h-6 w-6 items-center justify-center rounded-full bg-zinc-100 text-xs font-bold text-zinc-600 dark:bg-zinc-700 dark:text-zinc-300"><?php echo e(count($data['especies'])); ?></span>
                </div>
                <div class="space-y-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $data['especies']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $esp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="group">
                            <div class="mb-1.5 flex justify-between text-sm">
                                <span class="font-bold text-zinc-800 dark:text-zinc-200"><?php echo e($esp['label']); ?></span>
                                <span class="font-bold text-zinc-500"><?php echo e($esp['count']); ?> <span class="text-xs font-medium opacity-70">(<?php echo e($esp['percentage']); ?>%)</span></span>
                            </div>
                            <div class="h-2.5 w-full overflow-hidden rounded-full bg-zinc-100 dark:bg-zinc-700/50">
                                <div class="h-full rounded-full bg-emerald-500 transition-all duration-700 ease-out group-hover:bg-emerald-400" style="width: <?php echo e($esp['percentage']); ?>%"></div>
                            </div>
                        </div>
            ...
            <div class="rounded-[1.5rem] border border-zinc-200/60 bg-white/60 p-5 shadow-sm backdrop-blur-md dark:border-zinc-700/50 dark:bg-zinc-800/50">
                <div class="mb-5 flex items-center justify-between">
                    ...
                    <span class="flex h-6 w-6 items-center justify-center rounded-full bg-zinc-100 text-xs font-bold text-zinc-600 dark:bg-zinc-700 dark:text-zinc-300"><?php echo e(count($data['estados'])); ?></span>
                </div>
                <div class="space-y-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $data['estados']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $est): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="group">
                            <div class="mb-1.5 flex justify-between text-sm">
                                <span class="font-bold text-zinc-800 dark:text-zinc-200"><?php echo e($est['label']); ?></span>
                                <span class="font-bold text-zinc-500"><?php echo e($est['count']); ?> <span class="text-xs font-medium opacity-70">(<?php echo e($est['percentage']); ?>%)</span></span>
                            </div>
                            <div class="h-2.5 w-full overflow-hidden rounded-full bg-zinc-100 dark:bg-zinc-700/50">
                                <div class="h-full rounded-full bg-pink-500 transition-all duration-700 ease-out group-hover:bg-pink-400" style="width: <?php echo e($est['percentage']); ?>%"></div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <p class="py-4 text-center text-sm font-medium text-zinc-500">Sin datos registrados.</p>
            ...
            <div class="rounded-[1.5rem] border border-zinc-200/60 bg-white/60 p-5 shadow-sm backdrop-blur-md dark:border-zinc-700/50 dark:bg-zinc-800/50">
                <div class="mb-5 flex items-center justify-between">
                    ...
                    <span class="flex h-6 w-6 items-center justify-center rounded-full bg-zinc-100 text-xs font-bold text-zinc-600 dark:bg-zinc-700 dark:text-zinc-300"><?php echo e(count($data['productivo'])); ?></span>
                </div>
                <div class="space-y-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $data['productivo']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="group">
                            <div class="mb-1.5 flex justify-between text-sm">
                                <span class="font-bold text-zinc-800 dark:text-zinc-200"><?php echo e($prod['label']); ?></span>
                                <span class="font-bold text-zinc-500"><?php echo e($prod['count']); ?> <span class="text-xs font-medium opacity-70">(<?php echo e($prod['percentage']); ?>%)</span></span>
                            </div>
                            <div class="h-2.5 w-full overflow-hidden rounded-full bg-zinc-100 dark:bg-zinc-700/50">
                                <div class="h-full rounded-full bg-amber-500 transition-all duration-700 ease-out group-hover:bg-amber-400" style="width: <?php echo e($prod['percentage']); ?>%"></div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <p class="py-4 text-center text-sm font-medium text-zinc-500">Sin datos registrados.</p>
            ...
            <div class="rounded-[1.5rem] border border-zinc-200/60 bg-white/60 p-5 shadow-sm backdrop-blur-md dark:border-zinc-700/50 dark:bg-zinc-800/50">
                <div class="mb-5 flex items-center justify-between">
                    ...
                    <span class="flex h-6 w-6 items-center justify-center rounded-full bg-zinc-100 text-xs font-bold text-zinc-600 dark:bg-zinc-700 dark:text-zinc-300"><?php echo e(count($data['altas'])); ?></span>
                </div>
                <div class="space-y-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $data['altas']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="group">
                            <div class="mb-1.5 flex justify-between text-sm">
                                <span class="font-bold text-zinc-800 dark:text-zinc-200"><?php echo e($alt['label']); ?></span>
                                <span class="font-bold text-zinc-500"><?php echo e($alt['count']); ?> <span class="text-xs font-medium opacity-70">(<?php echo e($alt['percentage']); ?>%)</span></span>
                            </div>
                            <div class="h-2.5 w-full overflow-hidden rounded-full bg-zinc-100 dark:bg-zinc-700/50">
                                <div class="h-full rounded-full bg-blue-500 transition-all duration-700 ease-out group-hover:bg-blue-400" style="width: <?php echo e($alt['percentage']); ?>%"></div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <p class="py-4 text-center text-sm font-medium text-zinc-500">Sin datos registrados.</p>
...
<?php /**PATH G:\PROYECTOS\FUNDO_PARQUE v04\resources\views/components/animal-dashboard.blade.php ENDPATH**/ ?>