...
<div
    wire:key="<?php echo e($selectId); ?>"
    x-data="{
        open: false,
        value: $wire.entangle(<?php echo \Illuminate\Support\Js::from($model)->toHtml() ?>)<?php echo e($live ? '.live' : ''); ?>,
        disabled: <?php echo \Illuminate\Support\Js::from((bool) $disabled)->toHtml() ?>,
        options: <?php echo \Illuminate\Support\Js::from($items)->toHtml() ?>,
        activeIndex: 0,
        menuStyle: '',
        selectedIndex() {
    ...
    <?php echo e($attributes->class(['relative w-full', $compact ? 'min-w-[8.5rem]' : 'min-w-0'])); ?>
...
>
    <button
        ...
        aria-controls="<?php echo e($selectId); ?>-options"
        :aria-expanded="open"
    ...
    <template x-teleport="body">
        ...
        >
            <div x-ref="options" id="<?php echo e($selectId); ?>-options" role="listbox" class="max-h-64 overflow-y-auto overscroll-contain">
                <template x-for="(option, index) in options" :key="option.value">
                    <button
                        ...
                        :class="String(option.value) === String(value ?? '')
                            ? <?php echo \Illuminate\Support\Js::from($palette['selected'])->toHtml() ?>
                            : (activeIndex === index ? <?php echo \Illuminate\Support\Js::from($palette['active'])->toHtml() ?> : 'text-slate-600 dark:text-slate-300')"
...
<?php /**PATH G:\PROYECTOS\FUNDO_PARQUE v04\resources\views/components/filter-select.blade.php ENDPATH**/ ?>